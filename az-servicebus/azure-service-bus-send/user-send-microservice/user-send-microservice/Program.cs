...
namespace user_send_microservice
{
    class Program
    {
        ...
        {
            string ServiceBusConnectionString = "Endpoint=sb://messagesb.servicebus.windows.net/;SharedAccessKeyName=send;SharedAccessKey=p65uom2XbGfAU8dKqLYk9UBNPQEkSK7SI+ASbKY4GLM=";
