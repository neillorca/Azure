...
namespace ConsoleApp3
{
    class Program
    {
        ...
        {
            string ServiceBusConnectionString = "Endpoint=sb://messagesb.servicebus.windows.net/;SharedAccessKeyName=listen;SharedAccessKey=uy4Sju3gWRxyl44Igwl/XcGrNWmDq4l8v+ASbGdNVQE=";
            string TopicName = "messagesb-topic";
